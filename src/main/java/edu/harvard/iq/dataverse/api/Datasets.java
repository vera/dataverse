...
public class Datasets extends AbstractApiBean {
    ...
    public Response listRelations(
            ...
            @QueryParam("limit") Integer limit,
            @QueryParam("offset") Integer offset,
            @QueryParam("type") List<String> relationTypeNames,
            @QueryParam("datasetType") List<String> datasetTypeNames,
            @QueryParam("source") List<String> relationSources,
            @QueryParam("version") String versionNumber
    ) {
        return response(req -> {
            try {
                ...
                List<DatasetRelation> relations = datasetRelationService.getDatasetRelationsFor(dataset, version, relationTypeNames, datasetTypeNames, relationSources, effectiveLimit, effectiveOffset);
                long totalCount = datasetRelationService.getTotalDatasetRelationCountFor(dataset, version, relationTypeNames, datasetTypeNames, relationSources);
