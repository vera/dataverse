...
public class FeedbackUtilTest {
    ...
    public static void setUpClass() throws IOException, JsonParseException, AddressException {
        ...
        JsonParser jsonParser = new JsonParser(datasetFieldTypeSvc, null, settingsService, licenseService, datasetTypeService, datasetRelationService);
        ...
        JsonParser jsonParser2 = new JsonParser(datasetFieldTypeSvc, null, settingsService, licenseService, datasetTypeService, datasetRelationService);
        ...
        JsonParser jsonParserNoContacts = new JsonParser(datasetFieldTypeSvc, null, settingsService, licenseService, datasetTypeService, datasetRelationService);
